...
# TODO:  This removes all mediakey functionality
#        Find a way to replace itunes with spotify, instead
...
# Safari & WebKit                                                             #
###############################################################################
# Note: These settings seem to be ignored by Safari. Maybe find an alternative?
